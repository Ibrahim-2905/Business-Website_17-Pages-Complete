...
const ProcessTimeLineType3 = ({ 
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 py-7">
      {/* Title */}
      <h2 style={{fontWeight:"600"}} className="text-3xl md:text-4xl text-center text-charcoalGray mb-7">
        {title}
      </h2>
      ...
      <div className={`grid grid-cols-1 lg:gap-20  md:grid-cols-2  ${stepsArray.length > 4 ?  "lg:grid-cols-5" : "lg:grid-cols-4"} gap-8`} >
        {stepsArray.map((step, index) => (
          ...
          >
            ...
            {/* Card */}
            <div className="bg-lightGray p-6 pt-10 w-64 h-40 flex flex-col items-center justify-center shadow-md">
              {/* Step Title */}
              <h3 className="text-3xl font-semibold text-darkNavyBlue text-center mb-2">
                {step.title}
              </h3>
...
export default ProcessTimeLineType3;