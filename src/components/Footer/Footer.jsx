...
//               {/* Logo Image */}
//               <div className="w-20  flex items-center text-white justify-center">
//                 <img className='w-full h-full object-contain ' src="/logo/footerLogo1.png" alt="Mirage Works Logo" />
//               </div>
              
//               {/* Company Name */}
//               <div className="flex flex-col leading-tight">
//                 <span style={{fontWeight:"600"}} className="text-[17px]  font-poppins tracking-[0.2em]">MIRAGE</span>
//                 <span className="text-[9px] font-poppins tracking-[0.15em] -mt-0.5">WORKS</span>
//               </div>
//             </div>
  ...
  return (
    <footer className="bg-[#041435] text-white px-4 sm:px-8 md:px-16 lg:px-20 py-8 md:py-12">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-8">
          ...
          <div className="flex flex-col lg:col-span-1">
            <div className="flex items-center gap-2 mb-3">
              ...
              {/* Company Name */}
              <div className="flex flex-col leading-tight">
                <span style={{fontWeight:"600"}} className="text-[18px] font-poppins tracking-[0.2em]">MIRAGE</span>
                <span className="text-[10px] font-poppins tracking-[0.15em] -mt-0.5">WORKS</span>
              </div>
            </div>
            
            <p className="text-[14px] font-medium mb-2">Your Vision, Our Execution</p>
            
            <p className="text-[13px] leading-[1.6] opacity-80 mb-4 pr-4">
              Empowering businesses with comprehensive financial, ERP, and outsourcing solutions tailored for growth and efficiency.
            </p>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-[#f97316] text-[14px] font-semibold mb-4">Quick Links</h3>
            <ul className="space-y-2.5">
              <li>
                <a href="#" className="text-[14px] opacity-85 hover:opacity-100 hover:text-[#f97316] transition-all duration-300 inline-block">
                  Financial Solutions
                </a>
              </li>
              <li>
          ...
          {/* Company */}
          <div>
            <h3 className="text-[#f97316] text-[14px] font-semibold mb-4">Company</h3>
            <ul className="space-y-2.5">
              <li>
                <a href="#" className="text-[14px] opacity-85 hover:opacity-100 hover:text-[#f97316] transition-all duration-300 inline-block">
                  About us
          ...
          {/* Contact Us */}
          <div>
            <h3 className="text-[#f97316] text-[14px] font-semibold mb-4">Contact Us</h3>
            <div className="space-y-3">
              <div className="flex items-start gap-2.5">
                <svg className="w-4 h-4 flex-shrink-0 mt-0.5" viewBox="0 0 24 24" fill="#f97316">
                  <path d="M20.01 15.38c-1.23 0-2.42-.2-3.53-.56a.977.977 0 00-1.01.24l-1.57 1.97c-2.83-1.35-5.48-3.9-6.89-6.83l1.95-1.66c.27-.28.35-.67.24-1.02-.37-1.11-.56-2.3-.56-3.53 0-.54-.45-.99-.99-.99H4.19C3.65 3 3 3.24 3 3.99 3 13.28 10.73 21 20.01 21c.71 0 .99-.63.99-1.18v-3.45c0-.54-.45-.99-.99-.99z"/>
                </svg>
                <span className="text-[13px] opacity-90">+1234 567-8900</span>
              </div>
              ...
              <div className="flex items-start gap-2.5">
                ...
                <span className="text-[13px] opacity-90">info@mirageworks.com</span>
              </div>
              ...
              <div className="flex items-start gap-2.5">
                ...
                <span className="text-[13px] opacity-90 leading-[1.5]">1234 Business Ave, Suite 100 City, State 12345</span>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Footer Bottom */}
        <div className="border-t border-white/10 pt-5 flex flex-col sm:flex-row justify-between items-center gap-3 text-[12px] opacity-70">
          <div>© 2025 Mirage Works. All rights reserved.</div>
          <div className="flex gap-5">
            <a href="#" className="hover:text-[#f97316] transition-colors duration-300">
              Privacy Policy
