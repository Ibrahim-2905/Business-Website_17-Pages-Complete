...
export default function WhyChooseUsProcessOptimization() {
    const sapServices = [
        {
            title: "Boost Efficiency",
            description: "Streamlined & faster workflows"
        },
        {
            title: "Reduce Costs",
            description: "Lower operational costs & resource savings"
        },
        {
            title: "Improve Quality",
            description: "Consistent and error-free outputs"
        },
        {
            title: "Increase Scalability",
            description: "Flexible & scalable business processes"
        }
    ];
        ...
        >
            ...
            <div className="relative z-10 max-w-6xl mx-auto">
                ...
                <div className='text-center md:text-start py-10'>
                    <TitleDescription
                        title={
                            <><span style={{ fontWeight: "600" }} className='text-white  '>Key Benefits of Our Process Optimization Services</span></>
                        }
                    />
                </div>
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
                    ...
                    <div className="flex justify-center  lg:justify-end">
                        <img className='rounded-sm' src="/logo/WhyProcessOptimization1.png" alt="WhyProcessOptimization1" />
                    </div>
