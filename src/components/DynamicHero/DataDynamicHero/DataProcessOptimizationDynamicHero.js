export const DataProcessOptimizationDynamicHero ={
      image: "/logo/processOptimizationHero.jpg",
    ...
    horizontalLine: true,
    descriptionProps: {
        description: "Refining workflows for maximum efficiency and reduced costs.",
