export const DataAccountingBookkeepingDynamicHero = {
    image: "/logo/accountingHero.jpg",
    ...
    descriptionProps: {
        description: "Precision-driven financial record keeping for your peace of mind.",
